        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mb-3">
              <div class="col-12">
                <form
                  action="${baseURL}/admin/lophoc-list"
                  method="GET"
                ...
                <tbody>
                  ...
                  <c:forEach var="lop" items="${dsLopHoc}">
                    <tr>
                      ...
                      <td>
                        <span class="badge bg-secondary">${lop.tenKhoi}</span>
                      </td>
                      <td>${lop.tenNamHoc}</td>
                      ...
                      <td>
                        <div class="form-check form-switch">
                          ...
                          id="switch-${lop.maLop}" ${lop.trangThai ? 'checked' :
                          ''} onchange="toggleStatus('${lop.maLop}', this)">
                          <label
                            class="form-check-label"
                            for="switch-${lop.maLop}"
                          >
                      ...
                      <td>
                        ...
                        <a
                          href="${baseURL}/admin/lophoc-delete?id=${lop.maLop}"
                ...
                <nav aria-label="Page navigation">
                  <ul class="pagination justify-content-end mb-0">
                    <li class="page-item ${currentPage <= 1 ? 'disabled' : ''}">
                      <a
                        class="page-link"
                        href="${baseURL}/admin/lophoc-list?page=${currentPage - 1}&searchKey=${param.searchKey}"
                        >Trước</a
                      >
                    </li>
                    <c:forEach
                    ...
                    >
                      <li class="page-item ${i == currentPage ? 'active' : ''}">
                        <a
                          class="page-link"
                          href="${baseURL}/admin/lophoc-list?page=${i}&searchKey=${param.searchKey}"
                          >${i}</a
                        >
                      </li>
                    </c:forEach>
      ...
      <div class="modal-content">
        <form action="${baseURL}/admin/lophoc-add" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label"
                >Thuộc Khối <span class="text-danger">*</span></label
              >
