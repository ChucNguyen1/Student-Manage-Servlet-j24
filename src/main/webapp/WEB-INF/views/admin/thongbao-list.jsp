            ...
            <div class="card-body">
              ...
              <h5 class="card-title">
                ...
                <button type="button" class="btn btn-primary btn-sm float-end" 
                        data-bs-toggle="modal" data-bs-target="#modalThem">
              ...
              <div class="row mb-3">
                <div class="col-12">
                    <form action="${baseURL}/admin/thongbao-list" method="GET" class="d-flex justify-content-end">
                       <div class="input-group" style="width: 350px;">
                         <input type="text" name="searchKey" class="form-control" 
                                placeholder="Tìm theo tiêu đề..." value="${param.searchKey}">
                  ...
                  <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        <c:if test="${empty dsThongBao}">
                            <tr><td colspan="6" class="text-center">Không có thông báo nào.</td></tr>
                        </c:if>
                      ...
                      <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-end mb-0">
                              <li class="page-item ${currentPage <= 1 ? 'disabled' : ''}">
                                <a class="page-link" href="${baseURL}/admin/thongbao-list?page=${currentPage - 1}&searchKey=${param.searchKey}">Trước</a>
                              </li>
                              <c:forEach var="i" begin="1" end="${totalPages > 0 ? totalPages : 1}">
                                  <li class="page-item ${i == currentPage ? 'active' : ''}">
                                    <a class="page-link" href="${baseURL}/admin/thongbao-list?page=${i}&searchKey=${param.searchKey}">${i}</a>
                                  </li>
                              </c:forEach>
                              <li class="page-item ${currentPage >= totalPages ? 'disabled' : ''}">
                                <a class="page-link" href="${baseURL}/admin/thongbao-list?page=${currentPage + 1}&searchKey=${param.searchKey}">Sau</a>
                              </li>
                          </ul>
                      </nav>
                  </div>
          ...
          <form action="${baseURL}/admin/thongbao-add" method="POST">
              ...
              <div class="modal-body">
                  ...
                  <div class="mb-3">
                      ...
                      <textarea name="noiDung" class="form-control" rows="6" required></textarea>
                  </div>
              </div>
        ...
        <div class="modal-content">
          <form action="${baseURL}/admin/thongbao-edit" method="POST">
              ...
              <div class="modal-body">
                  ...
                  <div class="mb-3">
                      <label class="form-label">Tiêu đề <span class="text-danger">*</span></label>
                      <input type="text" id="tieuDe_edit" name="tieuDe" class="form-control" required>
                  </div>
                  <div class="mb-3">
                      <label class="form-label">Nội dung <span class="text-danger">*</span></label>
                      <textarea id="noiDung_edit" name="noiDung" class="form-control" rows="6" required></textarea>
                  </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
...
<script>
  document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (toastSuccessEl) new bootstrap.Toast(toastSuccessEl, {delay: 3000}).show();
