...
<main id="main" class="main">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mb-3">
              <div class="col-12">
                <form
                  action="${baseURL}/admin/monhoc-list"
                  method="GET"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-switch">
                          ...
                          id="switch-${mh.maMH}" ${mh.trangThai ? 'checked' :
                          ''} onchange="toggleStatus('${mh.maMH}', this)">
                          <label class="form-check-label"
                            >${mh.trangThai ? 'Hiển thị' : 'Ẩn'}</label
                          >
                        </div>
                      </td>
                      <td>
                        ...
                        <a
                          href="${baseURL}/admin/monhoc-delete?id=${mh.maMH}"
                          class="btn btn-danger btn-sm"
                          onclick="return confirm('Bạn có chắc muốn xóa vĩnh viễn môn [${mh.tenMH}] không?');"
            ...
            <div class="row align-items-center mt-3">
              <div class="col-md-6">
                <span class="text-muted"
                  ...
                  /><c:set var="endItem" value="${currentPage*pageSize}" /><c:if
                    test="${endItem > totalItems}"
                    ><c:set var="endItem" value="${totalItems}" /></c:if
                ...
                <nav>
                  <ul class="pagination justify-content-end mb-0">
                    <li class="page-item ${currentPage<=1?'disabled':''}">
                      <a
                        class="page-link"
                        href="${baseURL}/admin/monhoc-list?page=${currentPage-1}&searchKey=${param.searchKey}"
                        >Trước</a
                      >
                    </li>
                    <c:forEach
                      ...
                      ><li class="page-item ${i==currentPage?'active':''}">
                        <a
                          class="page-link"
                          href="${baseURL}/admin/monhoc-list?page=${i}&searchKey=${param.searchKey}"
                          >${i}</a
                        >
                      </li></c:forEach
                    >
  ...
  <div class="modal fade" id="modalThemMoi">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="${baseURL}/admin/monhoc-add" method="POST">
  ...
  <div class="modal fade" id="modalSua">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="${baseURL}/admin/monhoc-edit" method="POST">
          <div class="modal-header">
...
<script>
  function toggleStatus(id, cb) {
    const s = cb.checked;
    cb.nextElementSibling.textContent = s ? "Hiển thị" : "Ẩn";
