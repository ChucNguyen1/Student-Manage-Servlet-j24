...
<html lang="vi">
  <head>
    ...
    <title>Quản Lý Tài Khoản - Hệ Thống Quản Lý Học Sinh</title>
    <link
  ...
  <body>
    <%@ include file="/WEB-INF/includes/header.jsp" %> <%@ include
    file="/WEB-INF/includes/sidebar.jsp" %>

    <main id="main" class="main">
      <div class="pagetitle">
        <h1>
          <i class="bi bi-shield-lock"></i> Quản Lý Tài Khoản & Phân Quyền
        </h1>
        <nav>
          <ol class="breadcrumb">
            ...
            <div class="row mb-4">
              <div class="col-md-6">
                <div class="card border-primary">
                  <div class="card-body">
                    <h5 class="card-title">
                      <i class="bi bi-person-plus-fill text-primary"></i> Sinh
                      Tài Khoản Học Sinh
                    </h5>
                    <p class="card-text">
              ...
              <div class="col-md-6">
                <div class="card border-success">
                  <div class="card-body">
                    <h5 class="card-title">
                      <i class="bi bi-person-plus-fill text-success"></i> Sinh
                      Tài Khoản Giáo Viên
                    </h5>
                    <p class="card-text">
